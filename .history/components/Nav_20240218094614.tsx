      ...
      <div    className='p-3 top-0 z-50 sticky w-full bg-[#228B22] rounded-md  '>
          ...
          <div    className='flex py-4 gap-2 items-center justify-between '>
              <motion.div 
                    ...
                    className='flex text-2xl md:text-3xl  font-extrabold font-serif items-center gap-4 text-white'>
          ...
          <div  className="flex text-center justify-center text-slate-400 text-lg md:text-xl">
