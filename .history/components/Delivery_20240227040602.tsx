...
function Delivery() {
  return (
    <div className='  dark:bg-gray-800  py-4 grid grid-cols-1 sm:grid-cols-2 gap-3 '>
        {details?.map((b, i) => (
            <div className='flex flex-col text-center  bg-[#e6e6e6] p-2 gap-2 shadow-lgitems-center justify-center ' key={i}>
                <h2 className='text-green-500 text-center justify-center'>{b.icon}</h2>
