...
async function Product() {
  ...
  return (
    <div className='flex flex-col transition bg-emerald-200 ease-in-out delay-150 hover:-translate-y-1  duration-300  '>
        ...
        <Link className='flex p-4 items-center hover:text-xl cursor-pointer dark:text-white text-violet-600 gap-2' href={'/Latest'}>
