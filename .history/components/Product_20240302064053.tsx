...
async function Product() {
  ...
  return (
    <div className='flex flex-col transition bg-[#e6e6e6]    ease-in-out delay-150 hover:-translate-y-1  duration-300  '>
        <h1 className=' items-center text-center bg-[#7CFC00]  rounded-md font-serif font-extrabold justify-center p-4 text-2xl md:text-3xl dark:text-white text-gray-700'> Latest Product</h1>
