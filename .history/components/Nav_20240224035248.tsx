      ...
      <div    className='p-3 top-0 z-50 sticky w-full bg-[#228B22] rounded-md  '>
          ...
          <div    className='flex py-4 gap-2 items-center justify-between '>
              <motion.div 
                    ...
                    className='flex flex-col md:text-3xl justify-start   font-serif items-center  text-white'>
                    <div className="flex flex-col bg-[#228B22] font-extrabold text-2xl">
                    
                 
                      <Image className="flex justify-start" src={anky} alt="" width={80} height={60}/>
