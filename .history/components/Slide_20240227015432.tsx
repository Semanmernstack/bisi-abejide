    ...
    <div className=""> 
        ...
        <Carousel className='w-full' {...settings}>
                <div   className=' object-contain relative'    >
                    ...
                    <span className='absolute top-72 bg-green-500 px-4 py-4 right-52  max-w-xs rounded-2xl'>Shop now</span>
                    
                </div>
                <div   className=' object-contain relative'  >
                    <Image width={200} height={100} src={four} alt='pictwo'   />
                    <span className='absolute top-96 z-30 bg-green-500 px-4 py-4 right-52 max-w-xs rounded-2xl'>Shop now</span>
