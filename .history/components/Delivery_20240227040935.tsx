...
function Delivery() {
  return (
    <div className='flex  dark:bg-gray-800 text-center justify-center  py-4 grid grid-cols-1 sm:grid-cols-2 gap-3 '>
        {details?.map((b, i) => (
            <div className='flex flex-col  bg-[#e6e6e6] p-2 gap-2 shadow-lgitems-center justify-center ' key={i}>
