...
function Icon() {
  return (
    <div className='flex p-4 gap-2 shadow-lg items-center text-center justify-center   text-sm transition ease-in-out delay-150  hover:translate-y-1 hover:scale-95  duration-300      '>
