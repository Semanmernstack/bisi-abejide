    ...
    <div className=""> 
        ...
        <Carousel className='w-full' {...settings}>
                <div   className=' object-contain w-full relative'    >
                    ...
                    <span className='absolute   top-40 left-17 bg-green-500 px-4 py-4   w-[200px]  text-white font-bold rounded-2xl'>Shop now</span>
                    
                </div>
                <div   className=' object-contain w-full relative'  >
                    <Image width={200} height={100} src={four} alt='pictwo'   />
                    <span className='absolute  top-40 left-17 z-30 bg-green-500 px-4 py-4 w-[200px]  text-white font-bold rounded-2xl'>Shop now</span>
