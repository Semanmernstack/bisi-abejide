    ...
    <div className=" max-2xl mx-auto"> 
        ...
        <Carousel className='w-full ' {...settings}>
                <div   className='   relative'    >
                    <Image className=" object-cover h-1/2  w-96" src={one} alt='picone'  />
                ...
                <div   className='  relative'  >
                    <Image className='h-1/2 object-cover w-full  '    src={four} alt='pictwo'   />
                        <div  className='flex flex-col absolute top-1/2 left-1/3 z-30   bg-slate-500 px-4 py-4   text-white font-bold rounded-2xl'>
                            <h1 className=''>Welcome to <span className='text-lg md:text-xl'>LOLAFLO</span></h1>
                            <span className='text-xs animate-pulse'>Shop here</span>
                        </div>
                ...
                <div  className=' relative'>
                    <Image className=' h-1/2 object-cover w-full '    src={three} alt='picthree ' />
                    <div  className=' flex flex-col absolute top-1/2 left-1/3 z-30   bg-slate-500 px-4 py-4    text-white font-bold rounded-2xl'>
                        <h1 className=''>Welcome to <span className='text-lg md:text-xl'>LOLAFLO</span></h1>
                        <span className='text-xs animate-pulse'>Shop here</span>
                        </div>
                ...
                <div className='  relative '>
                    <Image className='h-1/2 object-cover w-full'   src={five} alt='picfoo'  />
                    <div  className=' flex flex-col absolute top-1/2 left-1/3 z-30   bg-slate-500 px-4 py-4  text-white font-bold rounded-2xl'>
                        <h1 className=''>Welcome to <span className='text-lg md:text-xl'>LOLAFLO</span></h1>
                        <span className='text-xs animate-pulse'>Shop here</span>
                        </div>
                ...
                <div  className='   relative'  >
                    <Image className='h-1/2  object-cover w-full'   src={two} alt='picfiv'/>
                    <div  className='flex flex-col absolute top-1/2 left-1/3 z-30   bg-slate-500 px-4 py-4  text-white font-bold rounded-2xl'>
                        <h1 className=''>Welcome to <span className='text-lg md:text-xl'>LOLAFLO</span></h1>
                        <span className='text-xs animate-pulse'>Shop here</span>
                        </div>
