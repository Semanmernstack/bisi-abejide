...
function ImageComp({images}: any) {
  ...
  return (
    <div className=" flex flex-col bg-transparent">
        <div className="p-5 flex  gap-2  sm:items-center ">
                ...
                <div className="flex items-center  justify-center hover:bg-pink-200  boder shadow-lg" key={index}>
                    <Image
                        onClick={()=> handleClick(ima)}
                         ...
                         width={100}
                         height={100}
                         className=" rounded-2xl flex items-center justify-center gap-2  hover:bg-pink-200  object-contain  cursor-pointer"
