...
async function Product() {
  ...
  return (
    <div className='flex flex-col transition bg-white   ease-in-out delay-150 hover:-translate-y-1  duration-300  '>
        <h1 className=' items-center text-center bg-fuchsia-600 py-2 px-2 rounded-md font-serif font-extrabold justify-center p-4 text-2xl md:text-3xl dark:text-white text-gray-700'> Categories</h1>
