...
function ImageComp({images}: any) {
  ...
  return (
    <div className=" flex flex-col max-w-2xl mx-auto border items-center justify-center bg-transparent">
        ...
        <div className="shadow-md items-center justify-center flex">
            <Image 
                ...
                className=" rounded-md  w-full h-130 object-contain cursor-pointer"
