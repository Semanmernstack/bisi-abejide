...
function Ai() {
  ...
  <Popup className='text-lg md:text-xl' trigger={<button>Important Notice</button>} position="bottom center">
    <div className='p-5 space-y-10 gap-2 flex flex-col items-center justify-center'>
      <span>Welcome to Lolaflo coutore</span>
      <span>Our aim and objectives is to build.......</span>
    </div>
  </Popup>
