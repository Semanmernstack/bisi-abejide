...
async function Anka() {
  ...
  return (
    ...
    <div className='grid grid-cols-1 p-2    gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid'>
        ...
        {datas.map(( p: any ) => (
        <div className='flex space-y-2 shadow-xl hover:bg-fuchsia-700 items-center justify-center hover:ease-out  rounded-lg p-3  flex-col  transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-95  duration-300   ' key={p._id}>
