...
async function Anka() {
  ...
  return (
    ...
    <h1 className=' items-center text-center bg-[#7CFC00] py-2 px-2 font-serif font-extrabold justify-center p-2 text-2xl md:text-3xl dark:text-white text-gray-700'>HOT PICK</h1>
