  ...
  return (
    ...
    <div className="">
      ...
      <div className="mt-6 border-2 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3    gap-2 lg:grid-cols-4  ">
        {datas?.map((p: any) => (
          <div key={p._id} className="p-3  border-2 shadow-2xl  flex flex-coltext-center justify-center ">
            <div className="  object-contain text-center justify-center rounded-lg">
              <Image
                src={p.images}
                alt="Product image"
                width={130}
