...
async function page({params,}: {params: {category: string}}) {
  ...
  return (
    ...
    <div className="">
      ...
      <div className="mt-6 border grid grid-cols-1 p-3 border-slate-300  gap-2 sm:grid-cols-2 lg:grid-cols-4 ">
        {datas.map((p: any) => (
          <div key={p._id} className="fflex flex-col items-center">
